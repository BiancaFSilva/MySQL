...
INSERT INTO `animal` (`codAnimal`, `nome`, `especie`, `sexo`, `cor`, `raca`, `peso`, `codDono`) VALUES
  ...
  (27, 'Pingo', 'Cachorro', 'Macho', 'Marrom', 'Pinscher', '4', 3),
	(28, 'Lord', 'Papagaio', 'Macho', 'Verde', 'Louro', '0.250', 1),
	(29, 'Lili', 'Cachorro', 'Fêmea', 'Marrom e preto', 'Pastor alemão', '20.8', 4),
	(30, 'Kitty', 'Cachorro', 'Fêmea', 'Marrom', 'SRD', '3.5', 4),
	(31, 'Polly', 'Cachorro', 'Fêmea', 'Marrom', 'SRD', '17.1', 2),
	(32, 'Pipoca', 'Cachorro', 'Fêmea', 'Marrom', 'SRD', '4.7', 4),
	(33, 'Thor', 'Cachorro', 'Macho', 'Branco e preto', 'Shih-tzu', '7.2', 1),
	(34, 'Tigor', 'Cachorro', 'Macho', 'Marrom', 'SRD', '13.4kg', 2),
	(35, 'Loki', 'Gato', 'Macho', 'Preto', 'Bombaim', '3.7kg', 1),
	(36, 'Pégaso', 'Cavalo', 'Macho', 'Marrom e branco', 'Mangalarga marchador', '356.8', 4);
